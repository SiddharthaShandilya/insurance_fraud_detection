...
def main():
    ...
    # removed_null_data_file_path = os.path.join(
    #     processed_data_dir_path, "model_training_no_null_data_file.csv"
    # )
    # imputed_data_file_path = os.path.join(
    #     processed_data_dir_path, "model_training_imputed_data_file.csv"
    # )
